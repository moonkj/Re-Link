    ...
    return const Column(
      ...
      children: [
        ...
        _Body('① 본 앱은 iOS 및 Android 기기에서 이용할 수 있습니다.\n'
            '② 일부 기능은 유료 플랜(BASIC, PREMIUM) 구매 후 이용 가능합니다.\n'
            '③ 서비스 이용을 위해 회원가입이나 계정 생성은 불필요합니다.'),
        SizedBox(height: AppSpacing.md),

        // 제4조
        _Heading('제4조 (요금제 및 결제)'),
        _Body('① 요금제는 1회성 구매 방식이며, 구독 방식이 아닙니다.\n'
            '② FREE 플랜: 무료, BASIC 플랜: ₩4,900, PREMIUM 플랜: ₩14,900\n'
            '③ BASIC → PREMIUM 업그레이드 시 차액(₩10,000)만 결제합니다.\n'
